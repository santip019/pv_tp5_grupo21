...
function Inicio() {
  return (
    <div className="intro container mt-4">
      <h1 className="intro-titulo text-center mb-3">
        Bienvenido al Sistema de Gestión de Alumnos
      </h1>
      <p className="intro-texto text-center">
        Este sistema te permitirá registrar, editar, eliminar y consultar
        información detallada de los estudiantes de nuestra institución.
      </p>
      ...
      <Carousel className="carousel-full">
        <Carousel.Item>
          ...
          <Carousel.Caption className="descripcion-carrusel">
            ...
            <p>
              Accede a la información completa de cada estudiante en un solo
              lugar.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className="descripcion-carrusel">
            ...
            <p>
              Edita fácilmente los datos de los alumnos cuando lo necesites.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption className="descripcion-carrusel">
            ...
            <p>
              Un sistema pensado para docentes, administrativos y directivos.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
